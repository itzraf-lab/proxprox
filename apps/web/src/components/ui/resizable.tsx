...
// v4 sets the flex direction inline on Group and exposes aria-orientation on
// Separator ("vertical" for a divider between side-by-side panels,
// "horizontal" for one between stacked panels), so the orientation-variant
// classes target aria-orientation instead of data-panel-group-direction.
