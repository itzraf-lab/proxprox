      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8 space-y-16">
          ...
          <div className="space-y-10">
            ...
            <Section id="privacy-sharing" title="3. Sharing &amp; third parties">
              <p>
                ...
                to that transmission. Beyond that, we do not sell, rent, or share your personal data
                or usage data with any third party.
              </p>
            </Section>
          ...
          <div className="space-y-10">
            ...
            <Section id="terms-acceptable-use" title="3. Acceptable use">
              <p>
            ...
            <Section id="terms-availability" title="4. Availability &amp; liability">
              <p>
            ...
            <Section id="terms-changes" title="5. Changes to these terms">
              <p>
